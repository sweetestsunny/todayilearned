...
async function loadFacts() {
  const res = await fetch(
    "https://hwmlrnzagjujdexyesvr.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh3bWxybnphZ2p1amRleHllc3ZyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDEzNDc0MzgsImV4cCI6MjAxNjkyMzQzOH0.EdwxcEjfUmL1MuGBv7aEmU8H8xdV4ZD6upoh6JOyHf8",
      },
    }
  );
...
console.log([7, 64, 5, -23, 11].filter((el) => el > 10));
console.log([7, 64, 5, -23, 11].find((el) => el > 10));
